...
export class DoctorController {
    ...
    // doctor-controller.ts (updated - getProfile and updateProfile methods)
// Get profile
async getProfile(req: Request, res: Response): Promise<void> {
    try {
        const doctorId = (req as any).doctor.doctorId;  // Updated from req.doctor.doctorId
        const doctor = await doctorService.getDoctorProfile(doctorId);
...
async updateProfile(req: Request, res: Response): Promise<void> {
    ...
    // }
        ...
        try {
            ...
            if (specialization) {
                // Use the new method for filtering by specialization
                doctors = await doctorService.getDoctorsBySpecialization(specialization as string);
            } else {
                // Get all doctors
